                                ...
                                <div class="question-box">
                                    @php
                                        ...
                                        for ($i = 0; $i < count($partes); $i += 2) {
                                            $clave = (int) $partes[$i]; // Convertimos a número entero
                                            $valor = trim($partes[$i + 1]); // Texto asociado
                                    ...
                                    <div class="question-value">
                                        @include('pdf.partials.render-value', [
                                            'type' => $childQ->type,
                                            'value' => $childVal . " - ". $resultado[$childVal],
                    ...
                    <div class="question-value">
                        ...
                        @if ($esPreguntaProyecto && $val)
                            @php
                                ...
                                $tituloProyecto = $proyectoDB ? $proyectoDB : "Proyecto no encontrado (ID: $val)";
                            @endphp
